...
export default function Home({ cycleTheme, currentThemeClass }) {
  // Custom theme icons matching your original UI setups
  const getThemeIcon = () => {
  ...
  return (
    <>
      ...
      {/* Dedicated Project Route Grid Maps */}
      <section id="projects" className="projects-section">
        ...
        <div className="projects-grid">
          ...
          <div className="project-card">
            ...
            <Link to="/ecommerce" className="view-link">View Live Project →</Link>
          </div>
          ...
          <div className="project-card">
            ...
            <Link to="/ai-generator" className="view-link">View Live Project →</Link>
          </div>
          ...
          <div className="project-card">
            ...
            <Link to="/task-manager" className="view-link">View Live Project →</Link>
          </div>

        </div>
      </section>

      {/* Working Delivery Form Inbox Setup */}
